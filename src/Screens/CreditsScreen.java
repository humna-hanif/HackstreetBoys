...
public class CreditsScreen extends Screen {
    ...
    public void initialize() {
        ...
        creditsLabel = new SpriteFont("Credits", 305, 49, "Serif Bold", 50, Color.red);
        createdByLabel = new SpriteFont("Created by Alex Thimineur for Quinnipiac's SER225 Course.", 130, 140, "Serif Bold", 20, Color.black);
        contributorsLabel = new SpriteFont("Thank you to QU Alumni Brian Carducci, Joseph White,\nand Alex Hutman for their contributions.", 130, 175, "Serif Bold",20, Color.black);
